...
var getPhotoObject = function (minLikes, maxLikes, commentsArray, commentsCount, photoCount) {
  var photoSetup = [];
...
var renderPhotos = function (minLikes, maxLikes, commentsArray, commentsCount, photoCount) {
  var fragment = document.createDocumentFragment();

  for (var i = 0; i < photoCount; i++) {
    fragment.appendChild(getPhotoTemplate(getPhotoObject(minLikes, maxLikes, commentsArray, commentsCount, photoCount)[i]));
  }

  pictureElement.appendChild(fragment);
};

renderPhotos(MIN_LIKES, MAX_LIKES, COMMENTS_ARRAY, COMMENTS_COUNT, PHOTO_COUNT);
